...
def main():
    ...
    while True:
        ...
        if type == 'H' or type == 'h':
            # Calculate gross pay
            gross = getPayHourlyCalcGross(True)

        # Commission calculations
        elif type == 'C' or type == 'c':
            gross = getPayComissionCalcGross(True)
        ...
        # Do calculations
        fica = calcFica(gross)
        stateTax = calcStateTax(gross)
        netPay = calcNetPay(gross, fica, stateTax)
...
def getPayComissionCalcGross(printOutput):
    ...
    while notDone:
        ...
        if printOutput:
            ...
            print("Initech Payroll Report")
            print("Gross:......................", round(gross, 2))
            print("First stage commission:.....",
                  round(firstTierCommission, 2))
            if secondTier >= 0:
...
def calcStateTax(gross):
    return gross * 0.0307

def calcNetPay(gross, fica, stateTax):
    return (gross - fica - stateTax)
